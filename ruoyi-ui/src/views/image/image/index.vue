<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="用户ID" prop="imageUserid">
        <el-input
          v-model="queryParams.imageUserid"
          placeholder="请输入用户ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="企业ID" prop="imageCompanyid">
        <el-input
          v-model="queryParams.imageCompanyid"
          placeholder="请输入企业ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="imageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户ID" align="center" prop="imageUserid" />
      <el-table-column label="企业ID" align="center" prop="imageCompanyid" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="用户ID" prop="imageUserid">
          <el-input v-model="form.imageUserid" placeholder="请输入用户ID" />
        </el-form-item>
        <el-form-item label="企业ID" prop="imageCompanyid">
          <el-input v-model="form.imageCompanyid" placeholder="请输入企业ID" />
        </el-form-item>
        <el-form-item label="图片路径" prop="imagePath">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除图片存储编号为"' + imageIds + '"的数据项？').then(function() {
